...
const SearchInput = ({ currentTag, currentSearch, cRef }) => {
  ...
  <input
    ...
    className={'outline-none w-full text-sm pl-4 transition focus:shadow-lg font-light leading-10 text-black bg-gray-100 dark:bg-gray-900 dark:text-white rounded-lg'}
    onKeyUp={handleKeyUp}
